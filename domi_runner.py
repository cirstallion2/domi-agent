...
def analyze_assets():
    ...
    for name, ticker in WATCHLIST.items():
        df_1h = get_kraken_data(ticker, 60)   # 1-Hour Execution
        df_4h = get_kraken_data(ticker, 240)  # 4-Hour True North
        ...
        for ma in [20, 50]:
            ...
            # THE SNIPER813PRO FILTER: Proximity + Volume + Trend Alignment
            if diff < 0.8: 
